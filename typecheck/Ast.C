                     ...
                     if (flag) { //float
                        switch (opCode()){
                            case OpNode::OpCode::EQ:
                                                code = new IntRelationCode(EFSA::OperandName::FEQ, left, right);
                                                break;
                            case OpNode::OpCode::NE:
                                                code = new IntRelationCode(EFSA::OperandName::FNE, left, right);
                                                break;
                            case OpNode::OpCode::GT:
                                                code = new IntRelationCode(EFSA::OperandName::FGT, left, right);
                                                break;
                            case OpNode::OpCode::GE:
                                                code = new IntRelationCode(EFSA::OperandName::FGE, left, right);
                                                break;
                            case OpNode::OpCode::LT:
                                                code = new IntRelationCode(EFSA::OperandName::FGT, right, left);
                                                break;
                            case OpNode::OpCode::LE:
                                                code = new IntRelationCode(EFSA::OperandName::FGE, right, left);
                                                break;
                            default:
                                                break;
                        }
